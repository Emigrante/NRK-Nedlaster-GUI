...
innhold fra NRK (både TV-serier, filmer og radio) til din egen PC. I stedet for å knote med kompliserte
...
* Laster ned alt: Enkeltepisoder, filmer, hele sesonger og radioprogrammer i én operasjon.
* Best kvalitet: Finner automatisk den beste videokvaliteten (eller du kan velge manuelt for TV).
* Språkvalg: Velg om du vil ha norsk, svensk eller dansk "språk-tag" på lyd/undertekst (for TV).
* Automatisk oppdeteksjon: Gjenkjenner automatisk om URL er fra TV (tv.nrk.no) eller Radio (radio.nrk.no).
* Radio-støtte: Laster ned radioprogrammer som MP3-audio i høy kvalitet.
...
2.  Finn det du vil se på tv.nrk.no eller radio.nrk.no i nettleseren din.
...
5.  Velg kvalitet og språk (bare tilgjengelig for TV-innhold - radio lastes alltid ned som MP3).

6.  Trykk på "START NEDLASTING" nede i høyre hjørne.

7.  Vent til fremdriftslinjen er ferdig. Kos deg med serier og radio!
